...
const Form = ({formOpen, setFormOpen, token, setToken, user, setUser, shoes, setShoes, change, setChange, setiFrameOpen}) => {
  ...
  return(
    <div className={formOpen ? "Form" : "Form hidden"}>
      {user!==null ?
        <NewRunForm token={token} user={user} shoes={shoes} setFormOpen={setFormOpen} change={change} setChange={setChange} setiFrameOpen={setiFrameOpen}/>
      :
...
const FormTab = ({user, setUser, token, setToken, shoes, setShoes, change, setChange, setiFrameOpen}) => {
  ...
  return (
    ...
    <div className="FormTab">
      <Form formOpen={formOpen} setFormOpen={setFormOpen} user={user} setUser={setUser} token={token} setToken={setToken} shoes={shoes} setShoes={setShoes} change={change} setChange={setChange} setiFrameOpen={setiFrameOpen} />
